    ...
    >
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm mt-0.5">
              Panduan lengkap fungsi setiap fitur, tombol, dan informasi pengembang platform
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-cyber-dark via-cyber-dark/80 to-cyber-cyan/10 border border-cyber-cyan/30 p-8 rounded-3xl space-y-4 shadow-xl">
        ...
        <p className="text-gray-300 text-xs sm:text-sm leading-relaxed max-w-4xl">
          <strong>WhaleWatch AI</strong> adalah platform intelijen cryptocurrency dan simulasi pasar modern yang dirancang untuk membantu trader maupun pemula memantau pergerakan bursa global. Dengan memanfaatkan perpaduan <strong>Neural Core AI (Groq Llama 3.1 & Gemini)</strong> dan data blockchain teragregasi, aplikasi ini membantu Anda mendeteksi arah sentimen pasar, memantau dompet transaksi paus raksasa, serta menguji strategi trading secara aman tanpa risiko finansial sungguhan.
        </p>
      </div>
      ...
      <div className="space-y-6">
        <div className="border-b border-gray-800 pb-3">
          <h2 className="text-xl font-black text-white tracking-wide flex items-center gap-2">
            <HelpCircle className="w-5 h-5 text-cyber-cyan" /> PANDUAN PENGGUNAAN FITUR & TOMBOL APLIKASI
          </h2>
      ...
      <div className="bg-cyber-dark border border-gray-800 p-8 rounded-3xl space-y-6">
        <div className="border-b border-gray-800 pb-3">
          <h2 className="text-xl font-black text-white tracking-wide flex items-center gap-2">
            <Award className="w-5 h-5 text-cyber-neon" /> INFORMASI PENGEMBANG (DEVELOPER CREDENTIALS)
          </h2>
          <p className="text-xs text-gray-400 mt-1">
            Platform ini dirancang, dikembangkan, dan dipelihara secara penuh oleh pengembang
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl">
          ...
          >
            ...
            <div>
              <span className="text-xs text-gray-400 block font-bold">INSTAGRAM PENGEMBANG:</span>
          ...
          >
            ...
            <div>
              <span className="text-xs text-gray-400 block font-bold">GITHUB REPOSITORI:</span>
